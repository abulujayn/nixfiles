# Frozen baseline; keep personal prompt changes in p10k.zsh.
# Generated by Powerlevel10k configuration wizard on 2026-08-04 at 14:09 AEST.
...
# vertical separators, flat heads, flat tails, 2 lines, solid, left frame,
...
() {
  ...
  # Prompt elements are defined in the personal p10k.zsh overrides.
